...
function EventsPages() {
    return (
        <div className="events-page-container w-full h-full flex flex-col items-center justify-center">
                        ...
                        {index % 2 === 0 ? (
                            <>
                                <div className="w-2/3 h-screen p-8">
                                    <img src="https://via.placeholder.com/150" alt="placeholder" className="h-full  mx-auto" />
                                </div>
