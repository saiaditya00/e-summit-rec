            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {user ? (
                ...
                <div className="flex flex-col space-y-2" >
                  ...
                  <button
                    onClick={() => navigate("/profile")}
                    className="block w-full text-left px-3 py-2 text-base font-medium text-white hover:text-purple-600 hover:bg-gray-50"
                  >
                    Profile
                  </button>
                  <button
                ...
                <div className="flex flex-col space-y-2 items-start">
                  ...
                  <button
                    onClick={handleGoogleSignIn}
                    className="bg-purple-600 text-white px-4 py-2 text-sm font-medium flex items-center space-x-2 w-auto"
                  >
                    <svg className="h-5 w-5" viewBox="0 0 24 24">
                      <path
                        fill="currentColor"
